...
\hline
\multirow{8}{=}{\centering Ricetta} & \multirow{8}{=}{\centering Descrittore di??.} &
...
\multirow{5}{=}{\centering Ingrediente} & \multirow{4}{=}{\centering Descrittore di ??.} &
...
\multirow{2}{=}{\centering Adesione} & \multirow{2}{=}{\centering Descrittore di ??.} &
\texttt{dataAdesione} (Data): data relativa all'adesione di uno studente ad una sessione.\\


\hline

\multirow{2}{=}{\centering Richiede} & \multirow{2}{=}{\centering Descrittore di ??.} &
...
\hline  
  ...
  \centering prepara & \centering Ad ogni sesisone in presenza si prepara una ricetta & Sessione [1..*] - Ricetta [0..*] \\

\hline

  \centering haBisogno & \centering ogni ricetta haBisogno di sapere la quantità degli ingredienti  & Richiede [1] - Ricetta [1..*] \\

\hline


  \centering necessita & \centering Un ingrediente necesista di sapre la quantita per la ricetta & Ingrediente [1..*] - Richiede [1] \\

\hline

  \centering per & \centering Richiesta di adesione per una sessione in presenza & Adesione [1..*] - Sessione [1] \\

\hline

  \centering ??? & \centering Iscrizione di uno Studente per un corso & Inscrizione [0..*] - Corso [1] \\
